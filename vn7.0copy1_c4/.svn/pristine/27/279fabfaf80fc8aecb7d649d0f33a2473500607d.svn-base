...
ELSE
  ...
  SELECT CASE ( lsm_id )
  CASE ( rivers )
    ! Standalone Rivers only uses a few driving variables as it is run
    ! independently of the rest of JULES.
    nvars_required = 2
    required_vars(1:2) = [ 'sub_surf_roff', 'surf_roff    ' ]
  CASE DEFAULT
