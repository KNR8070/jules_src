...
def copy_metadata(new_version):
    ...
    for dir in ["jules-fcm-make", "jules-standalone",
                "jules-shared/jules-surface",
                "jules-shared/jules-vegetation",
                "jules-shared/jules-nvegparm",
                "jules-shared/jules-surface-types"]:
        check_for_spurious_url_tags("../rose-meta/%s/HEAD/rose-meta.conf" % dir)
        rc, stdout, stderr = run_command("fcm cp ../rose-meta/%s/HEAD ../rose-meta/%s/vn%s"%(dir, dir, new_version))
...
if __name__ == '__main__':
    ...
    for dir in ["jules-fcm-make", "jules-standalone",
                ...
                "jules-shared/jules-nvegparm",
                "jules-shared/jules-surface-types"]:
        update_jules_version_metadata("../rose-meta/%s/vn%s/rose-meta.conf" % (dir, new_version), new_version)
