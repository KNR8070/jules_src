...
MODULE fill_disaggregated_precip_arrays_mod
...
USE update_mod, ONLY: l_daily_disagg, dur_ls_rain, dur_conv_rain,              &
...
END MODULE fill_disaggregated_precip_arrays_mod
