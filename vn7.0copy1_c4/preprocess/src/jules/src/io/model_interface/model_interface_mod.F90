...
!-----------------------------------------------------------------------------
! Metadata for land_fraction (flandg)
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
! Metadata for TRIP river storage on river routing grid
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox river storage",                                     &
! Units
    "kg"                                                                       &
  ) /
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_surface,                                                          &
! Long name
    "Gridbox river flow rate",                                                 &
! Units
    "kg m-2 s-1"                                                               &
  ) /
!-----------------------------------------------------------------------------
! Metadata for river routing runoff on model grid
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_surface,                                                          &
! Long name
    "Gridbox runoff rate received by river routing routine",                   &
! Units
    "kg m-2 s-1"                                                               &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
! Metadata for RFM surface storage on river routing grid
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox surface storage",                                   &
! Units
    "m3"                                                                       &
  ) /
!-----------------------------------------------------------------------------
! Metadata for RFM sub-surface storage on river routing grid
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox sub-surface storage",                               &
! Units
    "m3"                                                                       &
  ) /
!-----------------------------------------------------------------------------
! Metadata for RFM surface inflow on river routing grid
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox surface inflow",                                    &
! Units
    "m3 s-1"                                                                   &
  ) /
!-----------------------------------------------------------------------------
! Metadata for RFM sub-surface inflow on river routing grid
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox sub-surface inflow",                                &
! Units
    "m3 s-1"                                                                   &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
! Metadata for overbank inundation fraction on model grid
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_surface,                                                          &
! Long name
    "Growth (average) temperature for C3 photosynthesis",                      &
! Units
    "K"                                                                        &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
! Metadata for cs_label_gb
!-----------------------------------------------------------------------------
DATA metadata(605) / var_metadata(                                             &
! String identifier
    'cs_label_gb',                                                             &
! Variable type
    var_type_surface,                                                          &
! Long name
    "Gridbox total labelled soil carbon",                                      &
! Units
    "kg m-2"                                                                   &
  ) /
!-----------------------------------------------------------------------------
! Metadata for cs_label
!-----------------------------------------------------------------------------
DATA metadata(606) / var_metadata(                                             &
! String identifier
    'cs_label',                                                                &
! Variable type
    var_type_scpool,                                                           &
! Long name
    "Amount of labelled soil carbon",                                          &
! Units
    "kg m-2"                                                                   &
  ) /
!-----------------------------------------------------------------------------
! Metadata for resp_label_cs_gb
!-----------------------------------------------------------------------------
DATA metadata(607) / var_metadata(                                             &
! String identifier
    'resp_label_cs_gb',                                                        &
! Variable type
    var_type_surface,                                                          &
! Long name
    "Gridbox total labelled soil respiration",                                 &
! Units
    "kg m-2 s-1"                                                               &
  ) /
!-----------------------------------------------------------------------------
! Metadata for resp_label_cs
!-----------------------------------------------------------------------------
DATA metadata(608) / var_metadata(                                             &
! String identifier
    'resp_label_cs',                                                           &
! Variable type
    var_type_scpool,                                                           &
! Long name
    "Amount of labelled soil carbon respired",                                 &
! Units
    "kg m-2 s-1"                                                               &
  ) /
!-----------------------------------------------------------------------------
! Metadata for river routing latitude (river routing grid)
!-----------------------------------------------------------------------------
DATA metadata(609) / var_metadata(                                             &
! String identifier
    'rivers_lat_rp',                                                           &
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox latitude",                                          &
! Units
    "degrees"                                                                  &
  ) /
!-----------------------------------------------------------------------------
! Metadata for river routing longitude (river routing grid)
!-----------------------------------------------------------------------------
DATA metadata(610) / var_metadata(                                             &
! String identifier
    'rivers_lon_rp',                                                           &
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox longitude",                                         &
! Units
    "degrees"                                                                  &
  ) /
!-----------------------------------------------------------------------------
! Metadata for river flow on river routing grid
!-----------------------------------------------------------------------------
DATA metadata(611) / var_metadata(                                             &
! String identifier
    'rflow_rp',                                                                &
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox river flow rate",                                   &
! Units
    "kg m-2 s-1"                                                               &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
DATA metadata(612) / var_metadata(                                             &
! String identifier
    'rrun_rp',                                                                 &
! Variable type
    var_type_rp,                                                               &
...
!-----------------------------------------------------------------------------
! Metadata for river routing grid surface runoff
!-----------------------------------------------------------------------------
DATA metadata(613) / var_metadata(                                             &
! String identifier
    'rrun_surf_rp',                                                            &
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox surface runoff rate received by river " //          &
    "routing routine",                                                         &
! Units
    "kg m-2 s-1"                                                               &
  ) /
!-----------------------------------------------------------------------------
! Metadata for river routing grid sub-surface runoff
!-----------------------------------------------------------------------------
DATA metadata(614) / var_metadata(                                             &
! String identifier
    'rrun_sub_surf_rp',                                                        &
! Variable type
    var_type_rp,                                                               &
! Long name
    "River routing gridbox sub-surface runoff rate received by river " //      &
    "routing routine",                                                         &
! Units
    "kg m-2 s-1"                                                               &
  ) /
...
! Metadata for grid_area
!-----------------------------------------------------------------------------
DATA metadata(615) / var_metadata(                                             &
! String identifier
    'grid_area_rp',                                                            &
! Variable type
    var_type_rp,                                                               &
! Long name
    "Area of each river routing gridbox",                                      &
! Units
    "m2"                                                                       &
  ) /
!-----------------------------------------------------------------------------
! Metadata for overbank inundation fraction on river routing grid
!-----------------------------------------------------------------------------
DATA metadata(616) / var_metadata(                                             &
! String identifier
    'frac_fplain_rp',                                                          &
! Variable type
    var_type_rp,                                                               &
...
! Units
    "(fraction of river routing gridcell)"                                     &
  ) /
!-----------------------------------------------------------------------------
! Metadata for t_home_gb
!-----------------------------------------------------------------------------
DATA metadata(617) / var_metadata(                                             &
! String identifier
    't_home_gb',                                                               &
! Variable type
    var_type_surface,                                                          &
! Long name
    "Home temperature for C3 photosynthesis",                                  &
! Units
    "K"                                                                        &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
DATA metadata(618) / var_metadata(                                             &
! String identifier
    't1p5m_ij_clim_imgn',                                                      &
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen air temperature climatology",                                      &
! Units
    "K"                                                                        &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
DATA metadata(619) / var_metadata(                                             &
! String identifier
    'rh1p5m_ij_clim_imgn',                                                     &
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen relative humidity climatology",                                    &
! Units
    "%/K"                                                                      &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
DATA metadata(620) / var_metadata(                                             &
! String identifier
    'uwind_ij_clim_imgn',                                                      &
! Variable type
    var_type_imogen_drive,                                                     &
...
!-----------------------------------------------------------------------------
! Metadata for lwdown_ij_clim_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen longwave down climatology",                                        &
! Units
    "W/m2"                                                                     &
  ) /
!-----------------------------------------------------------------------------
! Metadata for swdown_ij_clim_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen shortwave down climatology",                                       &
! Units
    "W/m2"                                                                     &
  ) /
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen diurnal temeprature range climatology",                            &
! Units
    "K"                                                                        &
  ) /
!-----------------------------------------------------------------------------
! Metadata for precip_ij_clim_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen precipitation climatology",                                        &
! Units
    "kg/m2/s"                                                                  &
  ) /
!-----------------------------------------------------------------------------
! Metadata for pstar_ij_clim_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen surface pressure climatology",                                     &
! Units
    "Pa"                                                                       &
  ) /
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen air temperature anomaly",                                          &
! Units
    "K"                                                                        &
  ) /
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen relative humidity anomaly",                                        &
! Units
    "%"                                                                        &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
! Metadata for lwdown_ij_anom_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen longwave down anomaly",                                            &
! Units
    "W/m2"                                                                     &
  ) /
!-----------------------------------------------------------------------------
! Metadata for swdown_ij_anom_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen diurnal air temperature anomaly",                                  &
! Units
    "K"                                                                        &
  ) /
!-----------------------------------------------------------------------------
! Metadata for precip_ij_anom_imgn
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
! Metadata for pstar_ij_anom_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen surface pressure anomaly",                                         &
! Units
    "Pa"                                                                       &
  ) /
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen air temperature pattern",                                          &
! Units
    "K/K"                                                                      &
  ) /
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen relative humidity pattern",                                        &
! Units
    "%/K"                                                                      &
  ) /
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
! Metadata for lwdown_ij_patt_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen longwave down pattern",                                            &
! Units
    "W/m2/K"                                                                   &
  ) /
!-----------------------------------------------------------------------------
! Metadata for swdown_ij_patt_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen shortwwave down pattern",                                          &
! Units
    "W/m2/K"                                                                   &
  ) /
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen diurnal temeprature range pattern",                                &
! Units
    "K/K"                                                                      &
  ) /
!-----------------------------------------------------------------------------
! Metadata for precip_ij_patt_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen precipitation pattern",                                            &
! Units
    "kg/m2/s/K"                                                                &
  ) /
!-----------------------------------------------------------------------------
! Metadata for pstar_ij_patt_imgn
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_imogen_drive,                                                     &
! Long name
    "imogen surface pressure pattern",                                         &
! Units
    "Pa/K"                                                                     &
  ) /
!-----------------------------------------------------------------------------
! Metadata for wealth_index
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_surface,                                                          &
! Long name
    "Fraction of gridcell occupied by biocrops",                               &
! Units
    "1"                                                                        &
  ) /
!-----------------------------------------------------------------------------
! Metadata for frac_biocrop_prev
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_surface,                                                          &
! Long name
    "Fraction of gridcell occupied by biocrops (at previous timestep)",        &
! Units
    "1"                                                                        &
  ) /
!-----------------------------------------------------------------------------
! Metadata for harvest_biocrop
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_pft,                                                              &
! Long name
    "Carbon harvested from biocrops",                                          &
! Units
    "kg C m-2 per 360 days"                                                    &
  ) /
!-----------------------------------------------------------------------------
! Metadata for harvest_biocrop_gb
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_surface,                                                          &
! Long name
    "Carbon harvested from biocrops (gridbox mean)",                           &
! Units
    "kg C m-2 per 360 days"                                                    &
  ) /
!-----------------------------------------------------------------------------
! Metadata for harvest_biocrop_n
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_pft,                                                              &
! Long name
    "Nitrogen harvested from biocrops",                                        &
! Units
    "kg N m-2 per 360 days"                                                    &
  ) /
!-----------------------------------------------------------------------------
! Metadata for harvest_biocrop_n_gb
!-----------------------------------------------------------------------------
DATA metadata(651) / var_metadata(                                             &
! String identifier
    'harvest_biocrop_n_gb',                                                    &
! Variable type
    var_type_surface,                                                          &
! Long name
...
!-----------------------------------------------------------------------------
! Metadata for years_since_harvest
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_pft,                                                              &
! Long name
    "Years elapsed since most recent (periodic) harvest",                      &
! Units
    "Years"                                                                    &
  ) /
!-----------------------------------------------------------------------------
! Metadata for harvest_doy
!-----------------------------------------------------------------------------
...
! Variable type
    var_type_pft,                                                              &
! Long name
    "Day of year on which periodic harvest occurs",                            &
! Units
    "Days"                                                                     &
  ) /
!-----------------------------------------------------------------------------
! Metadata for plantNumDensity
!-----------------------------------------------------------------------------
...
CASE ( var_type_nmasst )
  ! Mass variables have 2 levels dimensions
  IF ( PRESENT(ndims) ) ndims = 2
  IF ( PRESENT(dim_names_in) )                                                 &
    dim_names_in(1:2) = [ pft_dim_name, nmasst_dim_name ]
  IF ( PRESENT(dim_names_out) )                                                &
    dim_names_out(1:2) = [ pft_dim_name_out, nmasst_dim_name_out ]
  IF ( PRESENT(dim_sizes) )                                                    &
    dim_sizes(1:2) = [ pft_dim_size, nmasst_dim_size ]
...
CASE ( var_type_imogen_drive )    ! imogen driving variables
  IF ( PRESENT(ndims) ) ndims = 1
  IF ( PRESENT(dim_names_in) ) dim_names_in(1) = imogen_drive_dim_name
  IF ( PRESENT(dim_names_out) ) dim_names_out(1) = imogen_drive_dim_name_out
  IF ( PRESENT(dim_sizes) ) dim_sizes(1) = imogen_drive_dim_size
...
USE jules_fields_mod, ONLY: crop_vars, psparms, toppdm, fire_vars, ainfo,      &
                            trif_vars, soilecosse, urban_param, progs,         &
                            trifctltype, jules_vars, fluxes, forcing,          &
                            lake_vars, chemvars, rivers

  !Use subroutines
! TYPE Definitions
USE jules_fields_mod, ONLY: toppdm
USE imgn_drive_mod, ONLY: imgn_drive
...
TYPE(data_cube) :: lw_up_cube, lw_down_cube
...
REAL :: workspace_pft(land_pts, npft)
                                ! Used in calculation of PFT variables
...
REAL :: workspace_rivers(np_rivers) ! Used in calculation of river
                                    ! grid variables (if rivers are off then
                                    ! this has size 0)
...
CASE ( 'rivers_lat_rp' )
  cube = cube_from_array(rivers%rivers_lat_rp)

CASE ( 'rivers_lon_rp' )
  cube = cube_from_array(rivers%rivers_lon_rp)

CASE ( 'land_fraction' )
  cube = cube_from_array(flandg)
...
CASE ( 'albedo_land' )
  ...
  cube_land = cube_from_array(                                                 &
    surftiles_to_gbm( (wght_alb(1) * fluxes%alb_surft(:,:,1) +                 &
                   wght_alb(2) * fluxes%alb_surft(:,:,2) +                     &
                   wght_alb(3) * fluxes%alb_surft(:,:,3) +                     &
                   wght_alb(4) * fluxes%alb_surft(:,:,4)), ainfo )             &
  )
  cube = map_from_land(cube_land)
...
CASE ( 'cs_label_gb' )
  IF ( nsoilt == 1) THEN
    !Case for a single soil tile
    cube_land = cube_from_array(SUM(SUM(progs%cs_pool_soilt(:,1,:,:) *         &
                                progs%frac_c_label_pool_soilt(:,1,:,:), 3), 2))
    cube = map_from_land(cube_land)
  ELSE
    CALL log_fatal("extract_var",                                              &
                   "Cannot output cs_label_gb for soil tiled runs")
  END IF
...
CASE ( 'elake' )
  ...
  IF ( .NOT. l_aggregate .AND. lake > 0 )                                      &
    workspace_land(:) = fluxes%fqw_surft(:,lake) * ainfo%frac_surft(:,lake)
  cube_land = cube_from_array(workspace_land)
  cube = map_from_land(cube_land)

CASE ( 'emis_gb' )
  cube_land = cube_from_array(surftiles_to_gbm(fluxes%emis_surft, ainfo))
  cube = map_from_land(cube_land)
...
CASE ( 'fsmc_gb' )
  ...
  workspace_land(:) = SUM(fluxes%fsmc_pft * ainfo%frac_surft(:,1:npft), 2)
...
CASE ( 'plantNumDensity' )
  cube_land = cube_from_array(progs%plantNumDensity)
  cube = map_from_land(cube_land)
...
CASE ( 'hf_snow_melt' )
  cube_land = cube_from_array(fluxes%hf_snow_melt_gb)
  cube = map_from_land(cube_land)
...
CASE ( 'lw_net' )
  ! Upward flux.
  cube_land = cube_from_array(surftiles_to_gbm(sf_diag%lw_up_surft, ainfo))
  lw_up_cube = map_from_land(cube_land)
  ! Downward flux.
  lw_down_cube = cube_from_array(forcing%lw_down_ij)
  ! Now calculate the net flux
  cube = lw_down_cube - lw_up_cube

  ! Free work cubes
  CALL cube_free(lw_up_cube)
...
CASE ( 'rad_net' )
  cube_land = cube_from_array(surftiles_to_gbm(fluxes%radnet_surft, ainfo))
  cube = map_from_land(cube_land)
...
CASE ( 'resp_label_cs_gb' )
  IF ( nsoilt == 1) THEN
    !Case for a single soil tile
    cube_land = cube_from_array(SUM(                                           &
                            SUM(trifctltype%resp_s_soilt(:,1,:,1:4) *          &
                            progs%frac_c_label_pool_soilt(:,1,:,1:4), 3), 2))
    cube = map_from_land(cube_land)
  ELSE
    CALL log_fatal("extract_var",                                              &
                   "Cannot output resp_label_cs_gb for soil tiled runs")
  END IF

CASE ( 'resp_label_cs' )
  IF ( nsoilt == 1) THEN
    !Case for a single soil tile
    cube_land = cube_from_array(trifctltype%resp_s_soilt(:,1,:,1:4) *          &
                                  progs%frac_c_label_pool_soilt(:,1,:,1:4))
    cube = map_from_land(cube_land)
  ELSE
    CALL log_fatal("extract_var",                                              &
                   "Cannot output resp_label_cs for soil tiled runs")
  END IF
...
CASE ( 'runoff' )
  cube_land = cube_from_array(fluxes%sub_surf_roff_gb(:) + fluxes%surf_roff_gb(:))
  cube = map_from_land(cube_land)
...
CASE ( 'snomlt_sub_htf' )
  cube_land = cube_from_array(fluxes%snomlt_sub_htf_gb)
  cube = map_from_land(cube_land)
...
CASE ( 'snow_melt_gb' )
  cube_land = cube_from_array(fluxes%snow_melt_gb)
  cube = map_from_land(cube_land)
...
CASE ( 'sub_surf_roff' )
  cube_land = cube_from_array(fluxes%sub_surf_roff_gb)
  cube = map_from_land(cube_land)

CASE ( 'surf_roff' )
  cube_land = cube_from_array(fluxes%surf_roff_gb)
  cube = map_from_land(cube_land)
...
CASE ( 'sw_net' )
  ...
  DO l = 1,land_pts
    ...
    workspace_land(l) = ( 1.0 - (                                              &
                          wght_alb(1) * fluxes%land_albedo_ij(i,j,1) +         &
                          wght_alb(2) * fluxes%land_albedo_ij(i,j,2) +         &
                          wght_alb(3) * fluxes%land_albedo_ij(i,j,3) +         &
                          wght_alb(4) * fluxes%land_albedo_ij(i,j,4)           &
...
CASE ( 'NDVI_land' )
  ...
  DO l = 1,land_pts
    ...
    i = ainfo%land_index(l) - (j-1) * t_i_length
    workspace_land(l) =                                                        &
      (((fluxes%land_albedo_ij(i,j,3) + fluxes%land_albedo_ij(i,j,4)) -        &
        (fluxes%land_albedo_ij(i,j,1) + fluxes%land_albedo_ij(i,j,2))) /       &
      ((fluxes%land_albedo_ij(i,j,3) + fluxes%land_albedo_ij(i,j,4)) +         &
        (fluxes%land_albedo_ij(i,j,1) + fluxes%land_albedo_ij(i,j,2))))
...
CASE ( 'tfall' )
  cube_land = cube_from_array(fluxes%tot_tfall_gb)
  cube = map_from_land(cube_land)
...
CASE ( 'flux_o3_stom' )
  cube_land = cube_from_array(chemvars%flux_o3_pft)
  cube = map_from_land(cube_land)

CASE ( 'fsmc' )
  cube_land = cube_from_array(fluxes%fsmc_pft)
  cube = map_from_land(cube_land)
...
CASE ( 'harvest_biocrop' )
  cube_land = cube_from_array(trif_vars%harvest_biocrop_pft)
  cube = map_from_land(cube_land)

CASE ( 'harvest_biocrop_gb' )
  cube_land = cube_from_array(trif_vars%harvest_biocrop_gb)
  cube = map_from_land(cube_land)

CASE ( 'harvest_biocrop_n' )
  cube_land = cube_from_array(trif_vars%harvest_biocrop_n_pft)
  cube = map_from_land(cube_land)

CASE ( 'harvest_biocrop_n_gb' )
  cube_land = cube_from_array(trif_vars%harvest_biocrop_n_gb)
  cube = map_from_land(cube_land)

CASE ( 'frac_biocrop' )
  cube_land = cube_from_array(trif_vars%frac_biocrop_gb)
  cube = map_from_land(cube_land)

CASE ( 'harvest_doy' )
  workspace_pft(:,:) = REAL(trif_vars%harvest_doy(:,:))
  cube_land = cube_from_array(workspace_pft)
  cube = map_from_land(cube_land)

CASE ( 'years_since_harvest' )
  workspace_pft(:,:) = REAL(progs%years_since_harvest(:,:))
  cube_land = cube_from_array(workspace_pft)
  cube = map_from_land(cube_land)
...
CASE ( 'o3_exp_fac' )
  cube_land = cube_from_array(chemvars%fo3_pft)
  cube = map_from_land(cube_land)
...
CASE ( 'cs_label' )
  IF (nsoilt == 1) THEN
    cube_land = cube_from_array(progs%cs_pool_soilt(:,1,:,:) *                 &
                                       progs%frac_c_label_pool_soilt(:,1,:,:))
    cube = map_from_land(cube_land)
  ELSE
    CALL log_fatal("extract_var",                                              &
                   "Cannot output GB mean value for cs when nsoilt > 1.")
...
CASE ( 'con_rain' )
  cube = cube_from_array(forcing%con_rain_ij)

CASE ( 'con_snow' )
  cube = cube_from_array(forcing%con_snow_ij)
...
CASE ( 'ecan_gb' )
  cube = cube_from_array(fluxes%ecan_ij)

CASE ( 'ei_gb' )
  cube = cube_from_array(fluxes%ei_ij)

CASE ( 'esoil_gb' )
  IF (nsoilt == 1) THEN
    cube = cube_from_array(fluxes%esoil_ij_soilt(:,:,1))
  ELSE
    CALL log_fatal("extract_var",                                              &
...
CASE ( 'land_albedo_1' )
  cube = cube_from_array(fluxes%land_albedo_ij(:,:,1))

CASE ( 'land_albedo_2' )
  cube = cube_from_array(fluxes%land_albedo_ij(:,:,2))

CASE ( 'land_albedo_3' )
  cube = cube_from_array(fluxes%land_albedo_ij(:,:,3))

CASE ( 'land_albedo_4' )
  cube = cube_from_array(fluxes%land_albedo_ij(:,:,4))

CASE ( 'upward_sw_1' )
  cube = cube_from_array(fluxes%land_albedo_ij(:,:,1) * forcing%sw_down_ij(:,:) * wght_alb(1))

CASE ( 'upward_sw_2' )
  cube = cube_from_array(fluxes%land_albedo_ij(:,:,2) * forcing%sw_down_ij(:,:) * wght_alb(2))

CASE ( 'upward_sw_3' )
  cube = cube_from_array(fluxes%land_albedo_ij(:,:,3) * forcing%sw_down_ij(:,:) * wght_alb(3))

CASE ( 'upward_sw_4' )
  cube = cube_from_array(fluxes%land_albedo_ij(:,:,4) * forcing%sw_down_ij(:,:) * wght_alb(4))

CASE ( 'latent_heat' )
  cube = cube_from_array(sf_diag%latent_heat)

CASE ( 'ls_rain' )
  cube = cube_from_array(forcing%ls_rain_ij)

CASE ( 'ls_snow' )
  cube = cube_from_array(forcing%ls_snow_ij)

CASE ( 'lw_down' )
  cube = cube_from_array(forcing%lw_down_ij)

CASE ( 'precip' )
  cube = cube_from_array(forcing%ls_rain_ij + forcing%con_rain_ij +            &
                         forcing%ls_snow_ij + forcing%con_snow_ij)

CASE ( 'pstar' )
  cube = cube_from_array(forcing%pstar_ij)

CASE ( 'q1p5m_gb' )
  cube = cube_from_array(sf_diag%q1p5m)

CASE ( 'qw1' )
  cube = cube_from_array(forcing%qw_1_ij)
...
CASE ( 'snowfall' )
  cube = cube_from_array(forcing%ls_snow_ij + forcing%con_snow_ij)
...
CASE ( 'surf_ht_flux_gb' )
  cube = cube_from_array(fluxes%surf_ht_flux_ij)

CASE ( 'sw_down' )
  cube = cube_from_array(forcing%sw_down_ij)
...
CASE ( 'tl1' )
  cube = cube_from_array(forcing%tl_1_ij)
...
CASE ( 'lwdown_ij_clim_imgn' )
  cube = cube_from_array(imgn_drive%lwdown_ij_clim)

CASE ( 'swdown_ij_clim_imgn' )
  cube = cube_from_array(imgn_drive%swdown_ij_clim)

CASE ( 'diurnal_t1p5m_ij_clim_imgn' )
  cube = cube_from_array(imgn_drive%diurnal_t1p5m_ij_clim)

CASE ( 'precip_ij_clim_imgn' )
  cube = cube_from_array(imgn_drive%precip_ij_clim)

CASE ( 'pstar_ij_clim_imgn' )
  cube = cube_from_array(imgn_drive%pstar_ij_clim)
...
CASE ( 'lwdown_ij_patt_imgn' )
  cube = cube_from_array(imgn_drive%lwdown_ij_patt)

CASE ( 'swdown_ij_patt_imgn' )
  cube = cube_from_array(imgn_drive%swdown_ij_patt)

CASE ( 'diurnal_t1p5m_ij_patt_imgn' )
  cube = cube_from_array(imgn_drive%diurnal_t1p5m_ij_patt)

CASE ( 'precip_ij_patt_imgn' )
  cube = cube_from_array(imgn_drive%precip_ij_patt)

CASE ( 'pstar_ij_patt_imgn' )
  cube = cube_from_array(imgn_drive%pstar_ij_patt)
...
CASE ( 'lwdown_ij_anom_imgn' )
  cube = cube_from_array(imgn_drive%lwdown_ij_anom)

CASE ( 'swdown_ij_anom_imgn' )
  cube = cube_from_array(imgn_drive%swdown_ij_anom)

CASE ( 'diurnal_t1p5m_ij_anom_imgn' )
  cube = cube_from_array(imgn_drive%diurnal_t1p5m_ij_anom)

CASE ( 'precip_ij_anom_imgn' )
  cube = cube_from_array(imgn_drive%precip_ij_anom)

CASE ( 'pstar_ij_anom_imgn' )
  cube = cube_from_array(imgn_drive%pstar_ij_anom)
...
CASE ( 'dt_range' )
  cube = cube_from_array(forcing%diurnal_temperature_range_ij)

CASE ( 'ext' )
  IF ( nsoilt == 1 ) THEN
    cube_land = cube_from_array(fluxes%ext_soilt(:,1,:))
    cube      = map_from_land(cube_land)
  ELSE
    DO k = 1, sm_levels
      workspace_levs(:,k) = soiltiles_to_gbm(fluxes%ext_soilt(:,:,k),ainfo)
    END DO
    cube_land = cube_from_array(workspace_levs(:,1:sm_levels))
    cube      = map_from_land(cube_land)
  END IF
...
CASE ( 'ext_soilt' )
  cube_land = cube_from_array(fluxes%ext_soilt)
  cube = map_from_land(cube_land)
...
CASE ( 'alb_tile_1' )
  cube_land = cube_from_array(fluxes%alb_surft(:,:,1))
  cube = map_from_land(cube_land)

CASE ( 'alb_tile_2' )
  cube_land = cube_from_array(fluxes%alb_surft(:,:,2))
  cube = map_from_land(cube_land)

CASE ( 'alb_tile_3' )
  cube_land = cube_from_array(fluxes%alb_surft(:,:,3))
  cube = map_from_land(cube_land)

CASE ( 'alb_tile_4' )
  cube_land = cube_from_array(fluxes%alb_surft(:,:,4))
  cube = map_from_land(cube_land)

CASE ( 'anthrop_heat' )
  cube_land = cube_from_array(fluxes%anthrop_heat_surft)
  cube = map_from_land(cube_land)
...
CASE ( 'ecan' )
  cube_land = cube_from_array(fluxes%ecan_surft)
  cube = map_from_land(cube_land)

CASE ( 'ei' )
  cube_land = cube_from_array(fluxes%ei_surft)
  cube = map_from_land(cube_land)

CASE ( 'emis' )
  cube_land = cube_from_array(fluxes%emis_surft)
  cube = map_from_land(cube_land)

CASE ( 'esoil' )
  cube_land = cube_from_array(fluxes%esoil_surft)
  cube = map_from_land(cube_land)
...
CASE ( 'fqw' )
  ...
  DO n = 1,nsurft
    DO j = 1,surft_pts(n)
      ...
      workspace_surft(l,n) = fluxes%ecan_surft(l,n) + fluxes%ei_surft(l,n) +   &
                             fluxes%esoil_surft(l,n)
      ! Add lake evaporation
      IF ( n == lake )                                                         &
        workspace_surft(l,n) = workspace_surft(l,n) + fluxes%fqw_surft(l,n)
    END DO
  END DO
...
CASE ( 'ftl' )
  cube_land = cube_from_array(fluxes%ftl_surft)
  cube = map_from_land(cube_land)
...
CASE ( 'le' )
  cube_land = cube_from_array(fluxes%le_surft)
  cube = map_from_land(cube_land)
...
CASE ( 'rad_net_tile' )
  cube_land = cube_from_array(fluxes%radnet_surft)
  cube = map_from_land(cube_land)

CASE ( 'sw_surft' )
  cube_land = cube_from_array(fluxes%sw_surft)
  cube = map_from_land(cube_land)
...
CASE ( 'snow_can_melt' )
  ! Only include tiles where canopy snow model is used
  DO i = 1,nsurft
    IF ( canSnowTile(i) ) workspace_surft(:,i) = fluxes%melt_surft(:,i)
  END DO
  cube_land = cube_from_array(workspace_surft)
  cube = map_from_land(cube_land)
...
CASE ( 'snow_melt' )
  workspace_surft(:,:) = fluxes%melt_surft(:,:)
...
CASE ( 'surf_ht_flux' )
  cube_land = cube_from_array(fluxes%surf_htf_surft)
  cube = map_from_land(cube_land)

CASE ( 'snow_soil_htf' )
  cube_land = cube_from_array(fluxes%snow_soil_htf)
  cube = map_from_land(cube_land)
...
CASE ( 'surf_ht_store' )
  cube_land = cube_from_array(fluxes%surf_ht_store_surft)
  cube = map_from_land(cube_land)
...
CASE ( 'z0' )
  IF ( ANY(l_vegdrag_surft) ) THEN
    cube_land = cube_from_array(fluxes%z0m_surft)
  ELSE
...
CASE ( 'z0h' )
  ...
  ELSE
    IF ( ANY(l_vegdrag_surft) ) THEN
      cube_land = cube_from_array(fluxes%z0h_surft)
    ELSE
      DO n = 1,nsurft
...
CASE ( 'isoprene_gb' )
  cube_land = cube_from_array(chemvars%isoprene_gb)
  cube = map_from_land(cube_land)

CASE ( 'isoprene' )
  cube_land = cube_from_array(chemvars%isoprene_pft)
  cube = map_from_land(cube_land)

CASE ( 'terpene_gb' )
  cube_land = cube_from_array(chemvars%terpene_gb)
  cube = map_from_land(cube_land)

CASE ( 'terpene' )
  cube_land = cube_from_array(chemvars%terpene_pft)
  cube = map_from_land(cube_land)

CASE ( 'methanol_gb' )
  cube_land = cube_from_array(chemvars%methanol_gb)
  cube = map_from_land(cube_land)

CASE ( 'methanol' )
  cube_land = cube_from_array(chemvars%methanol_pft)
  cube = map_from_land(cube_land)

CASE ( 'acetone_gb' )
  cube_land = cube_from_array(chemvars%acetone_gb)
  cube = map_from_land(cube_land)

CASE ( 'acetone' )
  cube_land = cube_from_array(chemvars%acetone_pft)
  cube = map_from_land(cube_land)
...
CASE ( 'rflow' )
  cube_land = cube_from_array(fluxes%rflow_gb)
  cube = map_from_land(cube_land)

CASE ( 'rrun' )
  cube_land = cube_from_array(fluxes%rrun_gb)
  cube = map_from_land(cube_land)

CASE ( 'rflow_rp' )
  cube = cube_from_array(rivers%rflow_rp)

CASE ( 'rrun_rp' )
  cube = cube_from_array(rivers%rrun_rp)

CASE ( 'rrun_surf_rp' )
  cube = cube_from_array(rivers%rrun_surf_rp)

CASE ( 'rrun_sub_surf_rp' )
  cube = cube_from_array(rivers%rrun_sub_surf_rp)

CASE ( 'grid_area_rp' )
  cube = cube_from_array(rivers%rivers_boxareas_rp)

CASE ( 'rivers_sto_rp' )
  cube = cube_from_array(rivers%rivers_sto_rp)

CASE ( 'rfm_bflowin_rp' )
  ! Internal units are m3/timestep, convert to m3/s
  workspace_rivers = rivers%rfm_bflowin_rp * nstep_rivers * timestep
  cube = cube_from_array(workspace_rivers)

CASE ( 'rfm_flowin_rp' )
  ! Internal units are m3/timestep, convert to m3/s
  workspace_rivers = rivers%rfm_flowin_rp * nstep_rivers * timestep
  cube = cube_from_array(workspace_rivers)

CASE ( 'rfm_substore_rp' )
  cube = cube_from_array(rivers%rfm_substore_rp)

CASE ( 'rfm_surfstore_rp' )
  cube = cube_from_array(rivers%rfm_surfstore_rp)

CASE ( 'frac_fplain_rp' )
  cube = cube_from_array(frac_fplain_rp)
...
CASE ( 'lake_depth' )
  cube_land = cube_from_array(lake_vars%lake_depth_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_fetch_gb' )
  cube_land = cube_from_array(lake_vars%lake_fetch_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_t_mean_gb' )
  cube_land = cube_from_array(lake_vars%lake_t_mean_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_t_mxl_gb' )
  cube_land = cube_from_array(lake_vars%lake_t_mxl_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_t_ice_gb' )
  cube_land = cube_from_array(lake_vars%lake_t_ice_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_h_mxl_gb' )
  cube_land = cube_from_array(lake_vars%lake_h_mxl_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_h_ice_gb' )
  cube_land = cube_from_array(lake_vars%lake_h_ice_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_shape_factor_gb' )
  cube_land = cube_from_array(lake_vars%lake_shape_factor_gb)
  cube = map_from_land(cube_land)

CASE ( 'g_dt_gb' )
  cube_land = cube_from_array(lake_vars%g_dt_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_t_sfc_gb' )
  cube_land = cube_from_array(lake_vars%lake_t_sfc_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_t_snow_gb' )
  cube_land = cube_from_array(lake_vars%lake_t_snow_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_h_snow_gb' )
  cube_land = cube_from_array(lake_vars%lake_h_snow_gb)
  cube = map_from_land(cube_land)

CASE ( 'lake_albedo_gb' )
  cube_land = cube_from_array(lake_vars%lake_albedo_gb)
  cube = map_from_land(cube_land)
...
CASE ( 't_home_gb' )
  cube_land = cube_from_array( progs%t_home_gb )
  cube = map_from_land(cube_land)
...
CASE ( 'water_demand' )
  ...
  !---------------------------------------------------------------------------
  ! Urban morphology on land points
  ! These are calculated when l_urban_empirical otherwise they will be the
  ...
  !---------------------------------------------------------------------------
CASE ( 'wrr' )
  cube_land = cube_from_array(urban_param%wrr_gb)
  cube = map_from_land(cube_land)

CASE ( 'hwr' )
  cube_land = cube_from_array(urban_param%hwr_gb)
  cube = map_from_land(cube_land)

CASE ( 'hgt' )
  cube_land = cube_from_array(urban_param%hgt_gb)
  cube = map_from_land(cube_land)
...
USE jules_surface_types_mod, ONLY: ncpft, nnpft, npft
...
REAL :: harvest_doy_real(land_pts, npft) ! Real version of harvest_doy

REAL :: years_since_harvest_real(land_pts, npft)
        ! Real version of years_since_harvest
...
IF ( .NOT. PRESENT(cube) .AND. .NOT. PRESENT(const_val) )                      &
  CALL log_fatal("populate_var",                                               &
                 "Neither data cube nor const_val have been provided for " //  &
...
CASE ( 'frac_biocrop' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, trif_vars%frac_biocrop_gb)
  ELSE
    trif_vars%frac_biocrop_gb(:) = const_val
  END IF
...
CASE ( 'frac_biocrop_prev' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs%frac_biocrop_prev_gb)
  ELSE
    progs%frac_biocrop_prev_gb(:) = const_val
  END IF

CASE ( 'harvest_doy' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    harvest_doy_real = REAL(trif_vars%harvest_doy)
    CALL cube_get_data(cube_land, harvest_doy_real)
    trif_vars%harvest_doy(:,:) = NINT(harvest_doy_real)
  ELSE
    trif_vars%harvest_doy(:,:) = NINT(const_val)
  END IF

CASE ( 'years_since_harvest' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    years_since_harvest_real = REAL(progs%years_since_harvest)
    CALL cube_get_data(cube_land, years_since_harvest_real)
    progs%years_since_harvest(:,:) = NINT(years_since_harvest_real)
  ELSE
    progs%years_since_harvest(:,:) = NINT(const_val)
  END IF
...
CASE ( 'lake_depth' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_depth_gb(:))
  ELSE
    lake_vars%lake_depth_gb(:) = const_val
  END IF

CASE ( 'lake_fetch_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_fetch_gb(:))
  ELSE
    lake_vars%lake_fetch_gb(:) = const_val
  END IF

CASE ( 'lake_h_mxl_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_h_mxl_gb(:))
  ELSE
    lake_vars%lake_h_mxl_gb(:) = const_val
  END IF

CASE ( 'lake_shape_factor_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_shape_factor_gb(:))
  ELSE
    lake_vars%lake_shape_factor_gb(:) = const_val
  END IF

CASE ( 'lake_t_mean_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_t_mean_gb(:))
  ELSE
    lake_vars%lake_t_mean_gb(:) = const_val
  END IF

CASE ( 'lake_t_mxl_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_t_mxl_gb(:))
  ELSE
    lake_vars%lake_t_mxl_gb(:) = const_val
  END IF

CASE ( 'lake_t_ice_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_t_ice_gb(:))
  ELSE
    lake_vars%lake_t_ice_gb(:) = const_val
  END IF

CASE ( 'lake_h_ice_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_h_ice_gb(:))
  ELSE
    lake_vars%lake_h_ice_gb(:) = const_val
  END IF

CASE ( 'lake_t_sfc_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, lake_vars%lake_t_sfc_gb(:))
  ELSE
    lake_vars%lake_t_sfc_gb(:) = const_val
  END IF
...
CASE ( 'frac_c_label_pool' )
  IF ( PRESENT(cube) ) THEN
    IF ( l_tile_soil .AND. l_broadcast_soilt) THEN
      !Spread around soilt dim
      cube_land = map_to_land(cube)
      CALL cube_get_data(cube_land, progs%frac_c_label_pool_soilt(:,1,:,:))
    ...
    ELSE
      CALL log_fatal("populate_var",                                           &
                     "Cannot populate frac_c_label_pool - failure in logic")
    END IF
  ELSE
    progs%frac_c_label_pool_soilt(:,:,:,:) = const_val
  END IF

CASE ( 'frac_c_label_pool_soilt' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs%frac_c_label_pool_soilt(:,:,:,:))
  ELSE
    progs%frac_c_label_pool_soilt(:,:,:,:) = const_val
  END IF
...
CASE ( 'plantNumDensity' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs%plantNumDensity(:,:,:))
  ELSE
    progs%plantNumDensity(:,:,:) = const_val
  END IF
...
CASE ( 'sub_surf_roff' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, fluxes%sub_surf_roff_gb)
  ELSE
    fluxes%sub_surf_roff_gb(:) = const_val
  END IF

CASE ( 'surf_roff' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, fluxes%surf_roff_gb)
  ELSE
    fluxes%surf_roff_gb(:) = const_val
  END IF
...
CASE ( 'pstar' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%pstar_ij)
  ELSE
    forcing%pstar_ij(:,:) = const_val
  END IF

CASE ( 'q' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%qw_1_ij)
  ELSE
    forcing%qw_1_ij(:,:) = const_val
  END IF
  forcing%qw_1_ij(:,:) = MAX(forcing%qw_1_ij, 0.0)

CASE ( 't' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube,forcing%tl_1_ij)
  ELSE
    forcing%tl_1_ij(:,:) = const_val
  END IF

CASE ( 'rad_net' )
  ! Net downward radiation is stored in lw_down until it is processed
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%lw_down_ij)
  ELSE
    forcing%lw_down_ij(:,:) = const_val
  END IF
...
CASE ( 'sw_net' )
  ...
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%sw_down_ij)
  ELSE
    forcing%sw_down_ij(:,:) = const_val
  END IF
...
CASE ( 'diff_rad' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%diff_rad_ij)
  ELSE
    forcing%diff_rad_ij(:,:) = const_val
  END IF

CASE ( 'dt_range' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%diurnal_temperature_range_ij)
  ELSE
    forcing%diurnal_temperature_range_ij(:,:) = const_val
  END IF

CASE ( 'precip' )
  ! Store total precip as large-scale rainfall until it is partitioned
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube,forcing%ls_rain_ij)
  ELSE
    forcing%ls_rain_ij(:,:) = const_val
  END IF
...
CASE ( 'tot_snow' )
  ...
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%ls_snow_ij)
  ELSE
    forcing%ls_snow_ij(:,:) = const_val
  END IF

CASE ( 'con_rain' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%con_rain_ij)
  ELSE
    forcing%con_rain_ij(:,:) = const_val
  END IF
...
CASE ( 'con_snow' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, forcing%con_snow_ij)
  ELSE
    forcing%con_snow_ij(:,:) = const_val
  END IF
...
CASE ( 'lwdown_ij_anom_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%lwdown_ij_anom)
  ELSE
    imgn_drive%lwdown_ij_anom(:,:,:) = const_val
  END IF

CASE ( 'swdown_ij_anom_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%swdown_ij_anom)
  ELSE
    imgn_drive%swdown_ij_anom(:,:,:) = const_val
  END IF
...
CASE ( 'precip_ij_anom_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%precip_ij_anom)
  ELSE
    imgn_drive%precip_ij_anom(:,:,:) = const_val
  END IF
...
CASE ( 'pstar_ij_anom_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%pstar_ij_anom)
  ELSE
    imgn_drive%pstar_ij_anom(:,:,:) = const_val
  END IF
...
CASE ( 'lwdown_ij_patt_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%lwdown_ij_patt)
  ELSE
    imgn_drive%lwdown_ij_patt(:,:,:) = const_val
  END IF

CASE ( 'swdown_ij_patt_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%swdown_ij_patt)
  ELSE
    imgn_drive%swdown_ij_patt(:,:,:) = const_val
  END IF
...
CASE ( 'precip_ij_patt_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%precip_ij_patt)
  ELSE
    imgn_drive%precip_ij_patt(:,:,:) = const_val
  END IF
...
CASE ( 'pstar_ij_patt_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%pstar_ij_patt)
  ELSE
    imgn_drive%pstar_ij_patt(:,:,:) = const_val
  END IF
...
CASE ( 'lwdown_ij_clim_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%lwdown_ij_clim)
  ELSE
    imgn_drive%lwdown_ij_clim(:,:,:) = const_val
  END IF

CASE ( 'swdown_ij_clim_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%swdown_ij_clim)
  ELSE
    imgn_drive%swdown_ij_clim(:,:,:) = const_val
  END IF
...
CASE ( 'precip_ij_clim_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%precip_ij_clim)
  ELSE
    imgn_drive%precip_ij_clim(:,:,:) = const_val
  END IF
...
CASE ( 'pstar_ij_clim_imgn' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, imgn_drive%pstar_ij_clim)
  ELSE
    imgn_drive%pstar_ij_clim(:,:,:) = const_val
  END IF
...
CASE ( 'latitude_2d' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, rivers%rivers_lat2d)
  ELSE
    rivers%rivers_lat2d(:,:) = const_val
  END IF

CASE ( 'longitude_2d' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, rivers%rivers_lon2d)
  ELSE
    rivers%rivers_lon2d(:,:) = const_val
  END IF

CASE ( 'direction' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, rivers%rivers_dir)
  ELSE
    rivers%rivers_dir(:,:) = const_val
  END IF

CASE ( 'sequence' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, rivers%rivers_seq)
  ELSE
    rivers%rivers_seq(:,:) = const_val
  END IF

CASE ( 'area' )
  IF ( PRESENT(cube) ) THEN
    CALL cube_get_data(cube, rivers%rivers_dra)
  ELSE
    rivers%rivers_dra(:,:) = const_val
  END IF
...
CASE ( 'rivers_ygrid' )
  IF ( PRESENT(cube) ) THEN
    ...
    CALL cube_get_data(cube_land, rivers%rivers_ygrid)
  ELSE
    rivers%rivers_ygrid(:) = const_val
  END IF
...
CASE ( 'rivers_xgrid' )
  IF ( PRESENT(cube) ) THEN
    cube_land = cube_create([ SIZE(cube%values) ])
    cube_land%values(:) = RESHAPE(cube%values, [ SIZE(cube%values) ])
    CALL cube_get_data(cube_land, rivers%rivers_xgrid)
  ELSE
    rivers%rivers_xgrid(:) = const_val
  END IF

CASE ( 'rivers_sto_rp' )
  IF ( PRESENT(cube) ) THEN
    cube_land = cube_create([ SIZE(cube%values) ])
    CALL cube_get_data(cube_land, rivers%rivers_sto_rp)
  ELSE
    rivers%rivers_sto_rp(:) = const_val
  END IF

CASE ( 'rfm_surfstore_rp' )
  IF ( PRESENT(cube) ) THEN
    cube_land = cube_create([ SIZE(cube%values) ])
    CALL cube_get_data(cube_land, rivers%rfm_surfstore_rp)
  ELSE
    rivers%rfm_surfstore_rp(:) = const_val
  END IF

CASE ( 'rfm_substore_rp' )
  IF ( PRESENT(cube) ) THEN
    cube_land = cube_create([ SIZE(cube%values) ])
    CALL cube_get_data(cube_land, rivers%rfm_substore_rp)
  ELSE
    rivers%rfm_substore_rp(:) = const_val
  END IF

CASE ( 'rfm_flowin_rp' )
  IF ( PRESENT(cube) ) THEN
    cube_land = cube_create([ SIZE(cube%values) ])
    CALL cube_get_data(cube_land, rivers%rfm_flowin_rp)
  ELSE
    rivers%rfm_flowin_rp(:) = const_val
  END IF

CASE ( 'rfm_bflowin_rp' )
  IF ( PRESENT(cube) ) THEN
    cube_land = cube_create([ SIZE(cube%values) ])
    CALL cube_get_data(cube_land, rivers%rfm_bflowin_rp)
  ELSE
    rivers%rfm_bflowin_rp(:) = const_val
  END IF
...
CASE ( 'ozone' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, chemvars%o3_gb)
  ELSE
    chemvars%o3_gb(:) = const_val
  END IF
...
CASE ( 'wealth_index' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, fire_vars%wealth_index)
  ELSE
    fire_vars%wealth_index(:) = const_val
  END IF

  !-----------------------------------------------------------------------------
  ! Variables for thermal acclimation of photosynthesis.
  !-----------------------------------------------------------------------------
CASE ( 't_home_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs%t_home_gb)
  ELSE
    progs%t_home_gb(:) = const_val
  END IF

CASE ( 't_growth_gb' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs%t_growth_gb)
  ELSE
...
CASE ( 'SoilTemp_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%SoilTemp_CABLE )
  ELSE
    progs_cbl_vars%SoilTemp_CABLE(:,:,:) = const_val
  END IF

CASE ( 'FrozenSoilFrac_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land,progs_cbl_vars%FrozenSoilFrac_CABLE )
  ELSE
    progs_cbl_vars%FrozenSoilFrac_CABLE(:,:,:) = const_val
  END IF

CASE ( 'SoilMoisture_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%SoilMoisture_CABLE )
  ELSE
    progs_cbl_vars%SoilMoisture_CABLE(:,:,:) = const_val
  END IF

CASE ( 'SnowDepth_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%SnowDepth_CABLE )
  ELSE
    progs_cbl_vars%SnowDepth_CABLE(:,:,:) = const_val
  END IF

CASE ( 'SnowAge_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%SnowAge_CABLE )
  ELSE
    progs_cbl_vars%SnowAge_CABLE(:,:) = const_val
  END IF

CASE ( 'SnowMass_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%SnowMass_CABLE )
  ELSE
    progs_cbl_vars%SnowMass_CABLE(:,:,:) = const_val
  END IF

CASE ( 'ThreeLayerSnowFlag_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%ThreeLayerSnowFlag_CABLE)
  ELSE
    progs_cbl_vars%ThreeLayerSnowFlag_CABLE(:,:) = const_val
  END IF

CASE ( 'SnowTemp_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%SnowTemp_CABLE )
  ELSE
    progs_cbl_vars%SnowTemp_CABLE(:,:,:) = const_val
  END IF

CASE ( 'SnowDensity_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%SnowDensity_CABLE)
  ELSE
    progs_cbl_vars%SnowDensity_CABLE(:,:,:) = const_val
  END IF

CASE ( 'OneLyrSnowDensity_CABLE' )
  IF ( PRESENT(cube) ) THEN
    cube_land = map_to_land(cube)
    CALL cube_get_data(cube_land, progs_cbl_vars%OneLyrSnowDensity_CABLE)
  ELSE
    progs_cbl_vars%OneLyrSnowDensity_CABLE(:,:) = const_val
  END IF
